...
//
// Параметры:
//   НомерПорта - Число - порт установки прямого соединения с сервером
//
Процедура УстановитьПортПрямогоДоступа(Знач НомерПорта) Экспорт
	...
	ПараметрыЗапускаАС.Вставить("direct-regport", XMLСтрока(НомерПорта));
...
//
// Параметры:
//   НомерПорта - Число - порт установки http соединения с сервером
//
Процедура УстановитьПортHttpДоступа(Знач НомерПорта) Экспорт
	...
	ПараметрыЗапускаАС.Вставить("http-port", XMLСтрока(НомерПорта));
