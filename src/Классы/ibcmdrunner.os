...
Перем ПоказыватьВыводНемедленно; // Флаг немеделенного вывода информации в лог
...
Процедура ПоказыватьВыводНемедленно(Знач Значение) Экспорт

    Ожидаем.Что(Значение).ИмеетТип("Булево");
    ПоказыватьВыводНемедленно = Значение;
...
Функция ВыполнитьКоманду(УстановленныйКодВозврата = 0)
    ...
    Команда.ПоказыватьВыводНемедленно(ПоказыватьВыводНемедленно);
